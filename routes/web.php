...
Route::post('review','HomeController@Reviewus')->name('review_us');
//=================================================================//
...
Route::get('shop-detail','ProductController@shopDetail')->name('shopDetail');
...
Route::resource('admin/childcategory', 'Admin\\ChildcategoryController');
