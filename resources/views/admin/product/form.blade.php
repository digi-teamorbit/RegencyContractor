...
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('childcategory') ? 'has-error' : ''}}">
    <div class="col-md-12">
        {!! Form::Label('item', 'Select Childcategory:') !!}
        
        {!! Form::select('item_id', $items, isset($product)?$product->Childcategory:null, ['class' => 'form-control']) !!}
    </div>
</div>
