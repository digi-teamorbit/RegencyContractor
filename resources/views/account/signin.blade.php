        ...
        <div class="carousel-caption">
          <div class="container">
            <div class="bannerCntnt">
              <h1 class="wow fadeInLeft" data-wow-delay="0.2s" data-wow-duration="2s">Login-Register</h1>
            </div>
          </div>
        </div>
      </div>
         ...
         <div class="container">
            <div class="col-xs-12 col-sm-6">
             ...
             <form method="POST" class="loginForm" id="login" action="{{ route('login') }}">
               ...
               <div class="form-group">
                  <input type="submit" class="webBtn" value="Log In">
               </div>
             </form>
            </div>
            ...
            <input type="password" class="form-control" placeholder="Retype Password" name="password_confirmation" id="signup-password" required>
               ...
               <div class="form-group">
                  <input type="submit" class="webBtn" value="Registered">
               </div>
