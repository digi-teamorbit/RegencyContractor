...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        if(auth()->user()->permissions()->where('name','=','add-'.$model)->first()!= null) {
			...
			$items = Childcategory::pluck('name', 'id');
    ...
    public function store(Request $request)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','add-'.$model)->first()!= null) {
			...
			$product->childcategory = $request->input('item_id');     
    ...
    { 
		...
		$requestData['childcategory'] = $request->input('item_id');
    /*Insert your data*/
            ...
            if(! is_null(request('images'))) {
                ...
                foreach ($photos as $photo) {
                    ...
                    DB::table('product_imagess')->insert([
                        ...
                        ['image' => $destinationPath.$filename, 'product_id' => $requestData->id]
